getExchange = function() {
    ...
    var urlYql = "http://query.yahooapis.com/v1/public/yql?q=select%20*%20from%20yahoo.finance.xchange%20where%20pair%3D%22EURBRL%22&format=json&env=store%3A%2F%2Fdatatables.org%2Falltableswithkeys";

    var urlApi = "../euro/service.ashx"
    ...
    $.getJSON(urlYql, function(d) {
        ...
        $.getJSON(urlApi, function(d) {
            ...
            spmundi = d.Cotacao[1].SPMUNDI[0][3].Value.replace(',', '.');
